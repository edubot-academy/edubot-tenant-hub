...
export function QuickActions() {
  return (
    ...
    >
      <button className="chunky-press p-6 bg-card border-2 border-border rounded-[24px] flex flex-col items-center justify-center gap-3 hover:border-primary/40 transition-colors cursor-pointer chunky-shadow">
      ...
      <button className="chunky-press p-6 bg-card border-2 border-border rounded-[24px] flex flex-col items-center justify-center gap-3 hover:border-accent/50 transition-colors cursor-pointer chunky-shadow">
      ...
      <button className="chunky-press col-span-2 p-5 bg-card border-2 border-border rounded-[24px] flex items-center justify-between hover:border-secondary/40 transition-colors cursor-pointer chunky-shadow">
